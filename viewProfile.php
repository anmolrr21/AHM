    ...
    <?php
        ...
        if( $type == "Individual"){
           ...
           ';
            ...
            $sql = "SELECT * FROM `org_users` where `Org_uid`=$forthisPages";
            $result = mysqli_query($conn,$sql);
            $row = mysqli_fetch_assoc($result);
            ...
            <p style="font-size:18px;font-weight:light;color:#333333;margin-left:20px; margin-top:50px;">"'.$row["description"].'"
               </p>
            </div>
           ';
